...
fn deserialize_struct(
    ...
    let (visitor, fields_stmt) =
        deserialize_struct_visitor(prefix, variant_ident, params, fields, cattrs, untagged);
...
fn deserialize_struct_visitor(
    ...
    let (field_visitor, fields_stmt) = if cattrs.has_flatten() {
        deserialize_struct_as_map_visitor(prefix, fields, cattrs)
    } else {
        deserialize_struct_as_struct_visitor(prefix, fields, cattrs)
    };
    ...
    let visitor_seed = if is_enum && cattrs.has_flatten() {
        Some(quote! {
            impl #de_impl_generics _serde::de::DeserializeSeed<#delife> for #visitor_name #de_ty_generics #where_clause {
                type Value = #this #ty_generics;
    ...
    let visitor = quote! {
        ...
        impl #de_impl_generics _serde::de::Visitor<#delife> for #visitor_name #de_ty_generics #where_clause {
            type Value = #this #ty_generics;
...
fn deserialize_internally_tagged_enum(
    ...
    quote_block! {
        ...
        impl<'de> _serde::de::Visitor<'de> for __Visitor {
            type Value = (#field_struct_name, _serde::__private::de::Content<'de>);
...
fn deserialize_adjacently_tagged_enum(
    ...
    let variant_arms: &Vec<_> = &variants
        ...
        .map(|(i, variant)| {
            ...
            quote! {
                #field_struct_name::#variant_index => #block
            }
        })
        .collect();
    ...
    let missing_content_arms = variants
        ...
        .filter_map(|(i, variant)| {
            ...
            Some(quote! {
                #field_struct_name::#variant_index => #arm,
            })
        })
        .collect::<Vec<_>>();
    ...
    let finish_content_then_tag = if variant_arms.is_empty() {
        quote! {
            match try!(_serde::de::MapAccess::next_value::<#field_struct_name>(&mut __map)) {}
        }
    } else {
        quote! {
    ...
    let visit_other = if collect_other_fields {
        quote! {
            ...
            where
                __E: _serde::de::Error,
            {
                _serde::__private::Ok(#this::__other(_serde::__private::de::Content::Bool(__value)))
            }
            ...
            where
                __E: _serde::de::Error,
            {
                _serde::__private::Ok(#this::__other(_serde::__private::de::Content::I8(__value)))
            }
            ...
            where
                __E: _serde::de::Error,
            {
                _serde::__private::Ok(#this::__other(_serde::__private::de::Content::I16(__value)))
            }
            ...
            where
                __E: _serde::de::Error,
            {
                _serde::__private::Ok(#this::__other(_serde::__private::de::Content::I32(__value)))
            }
            ...
            where
                __E: _serde::de::Error,
            {
                _serde::__private::Ok(#this::__other(_serde::__private::de::Content::I64(__value)))
            }
            ...
            where
                __E: _serde::de::Error,
            {
                _serde::__private::Ok(#this::__other(_serde::__private::de::Content::U8(__value)))
            }
            ...
            where
                __E: _serde::de::Error,
            {
                _serde::__private::Ok(#this::__other(_serde::__private::de::Content::U16(__value)))
            }
            ...
            where
                __E: _serde::de::Error,
            {
                _serde::__private::Ok(#this::__other(_serde::__private::de::Content::U32(__value)))
            }
            ...
            where
                __E: _serde::de::Error,
            {
                _serde::__private::Ok(#this::__other(_serde::__private::de::Content::U64(__value)))
            }
            ...
            where
                __E: _serde::de::Error,
            {
                _serde::__private::Ok(#this::__other(_serde::__private::de::Content::F32(__value)))
            }
            ...
            where
                __E: _serde::de::Error,
            {
                _serde::__private::Ok(#this::__other(_serde::__private::de::Content::F64(__value)))
            }
            ...
            where
                __E: _serde::de::Error,
            {
                _serde::__private::Ok(#this::__other(_serde::__private::de::Content::Char(__value)))
            }
            ...
            where
                __E: _serde::de::Error,
            {
                _serde::__private::Ok(#this::__other(_serde::__private::de::Content::Unit))
            }
        }
    } else {
        quote! {
...
fn deserialize_map(
    ...
    let ignored_arm = if cattrs.has_flatten() {
        Some(quote! {
            #field_struct_name::__other(__name) => {
    ...
    let match_keys = if cattrs.deny_unknown_fields() && all_skipped {
        quote! {
            // FIXME: Once we drop support for Rust 1.15:
            // let _serde::__private::None::<#field_struct_name> = try!(_serde::de::MapAccess::next_key(&mut __map));
            _serde::__private::Option::map(
                try!(_serde::de::MapAccess::next_key::<#field_struct_name>(&mut __map)),
                |__impossible| match __impossible {});
        }
    } else {
        quote! {
            while let _serde::__private::Some(__key) = try!(_serde::de::MapAccess::next_key::<#field_struct_name>(&mut __map)) {
                match __key {
                    #(#value_arms)*
                    #ignored_arm
                }
...
/// Generates name of `Field` struct
fn field_struct_name(prefix: &str) -> Ident {
    Ident::new(&format!("__{}Field", prefix), Span::call_site())
}

/// Generates name of `Visitor` struct
fn visitor_struct_name(prefix: &str) -> Ident {
